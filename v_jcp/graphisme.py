...
class Game():
    ...
    def setup(self):
        ...
        answer = Command("answer", " <someone> <number> <letter> : repondre <letter> à la <number> question du pnj <someone>", Actions.answer, 3)
        ...
        petitbarba = Character("petitbarba", "un barbapapa qui n'arrête pas de changer de forme", realisation, ["Bonjour", "1ere question : Qui es-tu ?\na : Je suis comme toi, je suis un barbapapa qui a rétréci.\nb : Je suis barba-perdu."], [realisation])
        realisation.characters["petitbarba"] = petitbarba
        petitbarba.answers = ["a"]
        marmotte = Character("marmotte", "un marmotte balèze", cyclop, ["1ere question:\na : Tu veux te battre avec moi ?\nb : Ou coopère et enfonce toi encore plus dans le terrier", "2eme question : Bon tu viens?\na : Oui\nb : Non"], [cyclop, farm])
        ...
        singe = Character("barba-singe", "un barba-singe qui s'est échappé des laboratoires", monkey, ["Prend cette banane"], [monkey, tree])
