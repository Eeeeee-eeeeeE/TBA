...
class Actions:
    ...
    def look(game, list_of_words, number_of_parameters):
        ...
        player.current_room.inventory.get_inventory()
    ...
    def take(game, list_of_words, number_of_parameters):
        ...
        #Si la direction entrée n'est pas connue, affichage d'un message d'erreur
        if object not in player.current_room.inventory.dict.keys() :
            command_word = list_of_words[0]
            print(MSG2.format(command_word=command_word, entered_world=object), end='')
            return False
        
        # Attrape l'oject.
        player.inventory.dict[object] = player.current_room.inventory.dict.get(object)
        del player.current_room.inventory.dict[object]
    ...
    def drop(game, list_of_words, number_of_parameters):
        ...
        #Si la direction entrée n'est pas connue, affichage d'un message d'erreur
        if object not in player.inventory.dict.keys() :
            command_word = list_of_words[0]
            print(MSG2.format(command_word=command_word, entered_world=object), end='')
            return False
        
        # Attrape l'oject.
        player.current_room.inventory.dict[object] = player.inventory.dict.get(object)
        del player.inventory.dict[object]
