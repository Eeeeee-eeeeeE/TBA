...
class Game:
    ...
    def setup(self):
        ...
        take = Command("take", " <item> : mettre l'item de la pièce dans son inventaire", Actions.take, 1)
        self.commands["take"] = take
        drop = Command("drop", " <item> : déposer l'item de son inventaire dans la pièce", Actions.drop, 1)
